...
SET INPUTFILE=%WORKDIR%\display_matarial_design_029.svg
...
IF "%COLOR1%"=="cyan"        SET PRIMARYHEX=#00BCD4    &  SET PRIMARYBRIGHT=dark
...
IF "%COLOR2%"=="teal"        SET SECONDARYHEX=#64FFDA  &  SET SECONDARYBRIGHT=light
IF "%COLOR2%"=="green"       SET SECONDARYHEX=#69F0AE  &  SET SECONDARYBRIGHT=dark
IF "%COLOR2%"=="lightgreen"  SET SECONDARYHEX=#B2FF59  &  SET SECONDARYBRIGHT=light
