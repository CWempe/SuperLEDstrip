...
NexText   p02version  = NexText(  1, 19, "p02version");
NexButton p02settings = NexButton(1,  9, "p02settings");
NexButton p02power    = NexButton(1, 18, "p02power");
...
NexText   p03version  = NexText(  2, 19, "p03version");
NexButton p03settings = NexButton(2,  9, "p03settings");
NexButton p03power    = NexButton(2, 18, "p03power");
...
NexText   p04version  = NexText(  3, 19, "p04version");
NexButton p04settings = NexButton(3,  9, "p04settings");
NexButton p04power    = NexButton(3, 18, "p04power");
...
NexText   p05version  = NexText(  4, 20, "p05version");
NexButton p05settings = NexButton(4,  9, "p05settings");
NexButton p05power    = NexButton(4, 18, "p05power");
...
NexText   p06version  = NexText(  5, 19, "p06version");
NexButton p06settings = NexButton(5,  9, "p06settings");
NexButton p06power    = NexButton(5, 18, "p06power");
...
NexText   p07version  = NexText(  6, 27, "p07version");
NexButton p07settings = NexButton(6,  9, "p07settings");
NexButton p07power    = NexButton(6, 18, "p07power");
...
NexButton p07c03      = NexButton(6, 19, "p07c03");
NexButton p07c04      = NexButton(6, 23, "p07c04");
NexButton p07c05      = NexButton(6, 11, "p07c05");
NexButton p07c06      = NexButton(6, 15, "p07c06");
NexButton p07c07      = NexButton(6, 20, "p07c07");
NexButton p07c08      = NexButton(6, 24, "p07c08");
NexButton p07c09      = NexButton(6, 12, "p07c09");
NexButton p07c10      = NexButton(6, 16, "p07c10");
NexButton p07c11      = NexButton(6, 21, "p07c11");
NexButton p07c12      = NexButton(6, 25, "p07c12");
NexButton p07c13      = NexButton(6, 13, "p07c13");
NexButton p07c14      = NexButton(6, 17, "p07c14");
NexButton p07c15      = NexButton(6, 22, "p07c15");
NexButton p07c16      = NexButton(6, 26, "p07c16");
// page 8
NexPage   p08         = NexPage(  7,  0, "p08");
NexText   p08title    = NexText(  7,  1, "p08title");
NexText   p08version  = NexText(  7, 30, "p08version");
NexButton p08settings = NexButton(7,  9, "p08settings");
NexButton p08power    = NexButton(7, 18, "p08power");
...
NexText   p08temp02   = NexText(  7, 19, "p08temp02");
NexText   p08humid02  = NexText(  7, 20, "p08humid02");
NexText   p08speed01  = NexText(  7, 29, "p08speed01");

// page 9
NexPage   p09            = NexPage(  8,  0, "p09");
NexText   p09title       = NexText(  8,  1, "p09title");
NexText   p09version     = NexText(  8, 31, "p09version");
NexButton p09settings    = NexButton(8, 10, "p09settings");
NexButton p09power       = NexButton(8, 12, "p09power");
NexSlider p09sliderRed   = NexSlider(8, 14, "p09sliderRed");
NexSlider p09sliderGreen = NexSlider(8, 15, "p09sliderGreen");
NexSlider p09sliderBlue  = NexSlider(8, 26, "p09sliderBlue");
NexButton p09redM        = NexButton(8, 11, "p09redM");
NexButton p09redP        = NexButton(8, 19, "p09redP");
NexButton p09greenM      = NexButton(8, 21, "p09greenM");
NexButton p09greenP      = NexButton(8, 22, "p09greenP");
NexButton p09blueM       = NexButton(8, 24, "p09blueM");
NexButton p09blueP       = NexButton(8, 25, "p09blueP");
NexText   p09red         = NexText(  8, 13, "p09red");
NexText   p09green       = NexText(  8, 20, "p09green");
NexText   p09blue        = NexText(  8, 23, "p09blue");
NexButton p09save1       = NexButton(8, 27, "p09save1");
NexButton p09load1       = NexButton(8, 29, "p09load1");
NexButton p09save2       = NexButton(8, 28, "p09save2");
NexButton p09load2       = NexButton(8, 30, "p09load2");
